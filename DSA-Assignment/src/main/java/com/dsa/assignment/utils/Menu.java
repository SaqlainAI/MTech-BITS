...
//        bst = new BST();
    ...
    public void displayMenu() {
        ...
        System.out.println("4. Input into Linked List Queue from File");
        System.out.println("5. Input into Linked List Queue from command line");
        System.out.println("6. Remove element from Linked List Queue");
        System.out.println("7. Input into Sorted Linked List from File");
        System.out.println("8. Input into Sorted Linked List from command line");
        System.out.println("9. Find element in Linked Sorted List");
        System.out.println("10. Remove element in Linked Sorted List");
